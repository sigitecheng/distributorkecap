...
<head>
  ...
  <title>Kecap Jaya Abadi</title>

  <!--
    - favicon
  -->
  <link rel="shortcut icon" href="../../assets/images/logo/restinajayaabadi.png" type="image/x-icon">
  ...
  <div class="modal" data-modal>
    ...
    <div class="modal-content">
      ...
      <div class="newsletter-img">
        <img src="./assets/images/restinajayaabadi.jpeg" alt="subscribe newsletter" width="400" height="400">
      </div>
      ...
      <div class="newsletter">
        ...
        <form action="#">
          ...
          <div class="newsletter-header">
            ...
            <h3 class="newsletter-title">Selamat datang di Kecap Jaya Abadi, 
            ...
            <p class="newsletter-desc">
              <!-- Subscribe the <b>Restina Jaya Abadi</b> to get latest products and discount update. -->
              Tujuan utama untuk inspirasi desain interior yang tak tertandingi! Jangan lewatkan kesempatan untuk mendapatkan akses eksklusif ke produk terbaru dan penawaran diskon yang menarik dengan berlangganan newsletter kami.
            </p>
      ...
      <div class="container">
        ...
        <ul class="header-social-container">
          ...
          <li>
            ...
            <h6 class="font-bold font-sans text-red-600" >PT. KECAP JAYA ABADI</h6>
        ...
        <a href="#" class="header-logo">
          ...
          <style>
            .custom-text {
              ...
              padding: 10px; /* Menambahkan padding agar lebih terlihat */
              font-family: Arial, sans-serif; /* Memilih jenis font */
              font-weight: bold; /* Memberikan tebal pada font */
              text-align: center; /* Pusatkan teks */
              border-radius: 5px; /* Membuat sudut border lebih halus */
              background-color: #f0f0f0; /* Memberikan warna latar belakang */
              box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.1); /* Menambahkan bayangan */
            }
          </style>
          
          <!-- <p class="custom-text"><i class="fab fa-raverly"></i>Restina Jaya Abadi</p> -->
          
          
          {{-- <img src="./assets/images/logo/restinajayaabadi.png" alt="Anon's logo" width="100" height="100"> --}}
        </a>

{{-- ----------------------------------------------- --}}

@include('fe_dashboard.menunotifikasi.index')

{{-- ----------------------------------------------- --}}
{{-- ----------------------------------------------- --}}

@include('fe_dashboard.menubarang.index')

{{-- ----------------------------------------------- --}}
{{-- ----------------------------------------------- --}}

@include('fe_dashboard.menuandroid.index')
        ...
        <div class="slider-container has-scrollbar">
          ...
          <div class="slider-item">
            <div class="banner-container">
              <img src="./assets/images/restinajayaabadi.jpeg" alt="women's latest fashion sale" class="banner-img">
              <!-- <img src="./assets/images/2.jpg" alt="women's latest fashion sale" class="banner-img"> -->
              <!-- <img src="./assets/images/3.jpg" alt="women's latest fashion sale" class="banner-img"> -->
          </div>
...
<!-- 
    ...
    {{-- @include('berita') --}}
    @include('fe_dashboard.berita.index')
{{--
  ...
  <footer class="bg-red-slate-500">

    {{-- ---------------------------------------------------- --}}

    @include('fe_dashboard.menubrand.index')

    {{-- ---------------------------------------------------- --}}
    {{-- ---------------------------------------------------- --}}

    @include('fe_dashboard.menufooter.index')
